class Forum {
    ...
    postQuestion(username, question) {
        ...
        if (!user || !user.isLoggedIn) {
            throw new Error("You should be logged in to post _questions");
        }
    ...
    postAnswer(username, questionId, answer) {
        ...
        if (!this._questions.find(q => q._id === questionId)) {
            throw new Error("There is no such question");
        }

        this._questions.find(q => q._id === questionId).answers.push({
            username: username,
            answer: answer
        });
    ...
    showQuestions() {
        ...
        for (const question of this._questions) {
            result += `Question ${question._id} by ${question.username}: ${question.question}\n`;
